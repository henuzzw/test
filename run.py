                        ...
                        with torch.no_grad():
                            ...
                            for k in range(len(pred)): 
                                ...
                                for x in datat['ans']:
                                    ...
                                    maxn = min(maxn, i)
                                score2.append(maxn)
                                each_epoch_pred[epoch][val_set.ids[k]] = lst[:]
                                #bans[epoch][val_set.ids[k]]=s[k] 怀疑度分数需要分数太多 暂时关了
                score = score2[0]
...
if __name__ == "__main__":
    ...
    args.modelName= sys.argv[6]
    args.layers= int(sys.argv[7])
